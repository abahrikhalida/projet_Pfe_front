...
//                 <td className="py-1.5 px-4 align-middle">
//                   <div className="flex items-center min-h-[32px]">
//                     <span className="text-[#FF8500] text-sm font-semibold">Total Regions</span>
//                   </div>
//                 </td>
//                 {baseColumns.map((col) => (
//                   <td key={col.key} className="py-1.5 px-4 align-middle text-center">
...
// TotalRegionsModal Component
const TotalRegionsModal = ({ totalData, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 rounded-t-2xl flex justify-between items-center z-10">
          <div>
            <h3 className="text-lg font-bold text-gray-800">Détails — Total Régions</h3>
          ...
          <table className="w-full table-fixed">
            ...
            <tfoot>
              <tr className="border-t-2 border-[#FF8500]/30 bg-[#FFF9F0]">
                <td className="py-1.5 px-4 align-middle">
                  <div className="flex items-center min-h-[32px]">
                    <span className="text-[#FF8500] text-sm font-semibold">Total Régions</span>
                  </div>
                </td>
                {baseColumns.map((col) => (
                  <td key={col.key} className="py-1.5 px-4 align-middle text-center">
