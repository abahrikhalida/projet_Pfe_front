...
//       try {
//         const res = await apiInstance.get("/recap/activite/?upload_id=1");
...
//             {/* Pas de Total pour activité (API ne le retourne pas) */}
//           </table>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {section.columns.map((col) => (
                  <div key={col.key} className="bg-[#FAFAFA] border border-gray-100 rounded-xl px-4 py-3 hover:border-[#FF8500]/30 hover:bg-[#FFF9F0] transition-colors">
                    ...
                    <p className="text-sm font-semibold text-gray-800">{fmt(activite[col.key])}</p>
                  </div>
                ))}
              </div>
            </div>
