...
// Modal Component
const ActiviteModal = ({ activite, onClose }) => {
  if (!activite) return null;
  const activiteName = activite.activite_nom || activite.activite;
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 rounded-t-2xl flex justify-between items-center z-10">
          <div>
            <h3 className="text-lg font-bold text-gray-800">Détails — Activité</h3>
            <p className="text-[#FF8500] font-semibold text-base">{activiteName}</p>
          </div>
          <button
            onClick={onClose}
...
// TotalActivitesModal Component
const TotalActivitesModal = ({ totalData, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 rounded-t-2xl flex justify-between items-center z-10">
          <div>
            <h3 className="text-lg font-bold text-gray-800">Détails — Total Activités</h3>
...
// Main Component
const ActiviteRecap = () => {
  const { activites, totalDivision, loading, error } = useActiviteRecap();
    ...
    <>
      <div className="bg-white rounded-[20px] shadow-sm border border-gray-100 p-6 font-kumbh">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold text-gray-800">Détail par Activité</h2>
          <span className="text-sm text-gray-500">{activites.length} activités</span>
        </div>
          ...
          <table className="w-full table-fixed">
            ...
            <tfoot>
              <tr className="border-t-2 border-[#FF8500]/30 bg-[#FFF9F0]">
                <td className="py-1.5 px-4 align-middle">
                  <div className="flex items-center min-h-[32px]">
                    <span className="text-[#FF8500] text-sm font-semibold">Total Activités</span>
                  </div>
                </td>
                {baseColumns.map((col) => (
                  <td key={col.key} className="py-1.5 px-4 align-middle text-center">
