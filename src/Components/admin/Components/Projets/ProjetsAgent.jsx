// Components/Projets/ProjetsAgent.jsx
...
const ProjetsAgent = () => {
    const [activeTab, setActiveTab] = useState('validesDR');
    ...
    const tabs = [
        { id: 'validesDR', label: ' À Traiter', endpoint: '/recap/budget/agent/valides-dr/', color: 'blue', description: 'Projets validés par DR à traiter', icon: '📋' },
        { id: 'reserve', label: ' Réservés', endpoint: '/recap/budget/agent/reserve/', color: 'orange', description: 'Projets que vous avez réservés', icon: '🔄' },
        { id: 'valides', label: ' Validés', endpoint: '/recap/budget/agent/valides/', color: 'green', description: 'Projets déjà validés', icon: '✅' },
        { id: 'tous', label: 'Tous', endpoint: '/recap/budget/agent/tous/', color: 'purple', description: 'Tous les projets accessibles', icon: '📊' },
        { id: 'historique', label: 'Historique', endpoint: '/recap/budget/agent/historique/', color: 'gray', description: 'Historique complet', icon: '📜' }
    ];
    ...
    const getStatutBadge = (statut) => {
        const config = {
            ...
            reserve_agent: { label: 'Réservé', color: '#F59E0B', bg: 'bg-amber-100' },
            valide_agent: { label: 'Validé Agent', color: '#10B981', bg: 'bg-green-100' }
        };
    ...
    return (
        <>
            <ProjetsLayout
                ...
                subtitle="Gérez les projets à traiter, suivez vos validations"
                tabs={tabs}
                projets={projets}
                loading={loading}
                ...
                canShowValidationActions={activeTab === 'validesDR' || activeTab === 'reserve'}
