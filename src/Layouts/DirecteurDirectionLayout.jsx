...
export const DirecteurDirectionLayout = () => {
  ...
  useEffect(() => {
    const fetchDirectionInfo = async () => {
      ...
      try {
        const response = await axiosInstance.get(`/params/directions/${directionId}`);
        const direction = response.data.data || response.data;
  ...
  const mainMenuItems = [
    { name: "Dashboard", icon: <DashboardIcon />, path: "/directeur-direction/dashboard" },
    { name: "Départements", icon: <GroupesIcon />, path: "/directeur-direction/departements" },
    { name: "Responsables", icon: <GroupesIcon />, path: "/directeur-direction/responsables" },
    { name: "Paramètres", icon: <ParametersIcon />, path: "/directeur-direction/parametres" },
    { name: "Affectation", icon: <GroupesIcon />, path: "/directeur-direction/affectation" },
  ];

  const projectMenuItems = [
    { name: "Projets", icon: <ThemesIcon />, path: "/directeur-direction/projets" },
    { name: "Classification", icon: <ClassificationIcon />, path: "/directeur-direction/classification" },
    { name: "Risque Analyse", icon: <RisqueIcon />, path: "/directeur-direction/risque" },
    { name: "Rapport", icon: <RapportIcon />, path: "/directeur-direction/rapport" },
  ];

  const settingsMenuItems = [
    { name: "Profile", icon: <ProfileIcon />, path: "/directeur-direction/profile" },
    { name: "Notification", icon: <NotifIcon />, path: "/directeur-direction/notification" },
  ];
