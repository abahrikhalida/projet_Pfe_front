...
export const DirecteurRegionLayout = () => {
  ...
  useEffect(() => {
    // Récupérer le nom de la région depuis localStorage ou API
  ...
  const mainMenuItems = [
    { name: "Dashboard", icon: <DashboardIcon />, path: "/directeur-region/dashboard" },
    ...
    { name: "Paramètres", icon: <ParametersIcon />, path: "/directeur-region/parametres" },
     { name: "Affectation", icon: <GroupesIcon />, path: "/directeur-region/affectation" },
  ];

  const projectMenuItems = [
    { name: "Projets", icon: <ThemesIcon />, path: "/directeur-region/projets" },
    { name: "Recap", icon: <ThemesIcon />, path: "/directeur-region/recap" },
    { name: "Classification", icon: <ClassificationIcon />, path: "/directeur-region/classification" },
    { name: "Risque Analyse", icon: <RisqueIcon />, path: "/directeur-region/risque" },
    { name: "Rapport", icon: <RapportIcon />, path: "/directeur-region/rapport" },
  ];

  const settingsMenuItems = [
    { name: "Profile", icon: <ProfileIcon />, path: "/directeur-region/profile" },
    { name: "Notification", icon: <NotifIcon />, path: "/directeur-region/notification" },
  ];
